...
export default function Page() {
  ...
  const lines = syncRows.filter((r) => !r.received).map((r) => {
    ...
    return {
      ...
      shipped: r.sync.shipped,
      etaShort: shortDate(eta),
      issuableShort: shortDate(addDays(eta, policy.inboundQcDays)),
      stopShort: shortDate(row.stockoutDate.value),
      qcDays: policy.inboundQcDays,
