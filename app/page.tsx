...
import { StagePicker } from '@/components/onboard/StagePicker'
...
function Dashboard() {
  ...
  // The owner's home is the stage picker: which part of the business am I
  // working on. The sample company keeps the executive dashboard, which is what
  // it is for — a worked example of where the whole thing ends up.
  if (wsMode === 'mine') return <StagePicker />
