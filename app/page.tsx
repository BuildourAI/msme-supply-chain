  ...
  return (
    <>
      ...
      <div className="mb-3 space-y-3">
        <ExecSection no={1} index={0} hue="var(--accent)" title="Inbound procurement" kpis={inbound} charts={charts} notes={notes}
        ...
        <ExecSection no={2} index={1} hue="var(--good)" title="Warehouse & inventory health" kpis={warehouse} charts={charts} notes={notes}
          blurb="Whether the cash is rotting on shelves, or the line is about to stop" />

        <ExecSection no={3} index={2} hue="var(--cat-1)" title="Outbound fulfilment" kpis={outbound} charts={charts} notes={notes}
        ...
        <ExecSection no={4} index={3} hue="var(--cat-4)" title="Supply chain financials" kpis={financial} charts={charts} notes={notes}
