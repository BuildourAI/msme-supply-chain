  ...
  },
  {
    ...
    problems: [
      ...
      { title: 'No item master', detail: 'The factory and the customer use different names for the same thing.',
        ...
        how: 'The supplier-intake mapping table is the item master’s alias list, and it lives on the intake screen that produces it rather than being repeated here. A confirmed match is permanent, so the name the supplier uses and the name the factory uses resolve to the same stock everywhere downstream without anyone re-keying either.' },
