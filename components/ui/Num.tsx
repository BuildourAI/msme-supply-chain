...
export function Num({ d, format = 'qty', dp, tone, className = '', suffix, size = 'md' }: {
  ...
  return (
    <button
      ...
      className={`press num inline-flex items-baseline gap-1 rounded-sm underline decoration-dotted decoration-ink-3/40 underline-offset-[3px] hover:decoration-accent hover:text-accent-ink ${sz} ${tone ? TONE_FG[tone] : ''} ${flash} ${className}`}
    >
